...
public class PaneModificarPlatos {
    ...
    public void DiseñoVentanaPlatos(Stage primaryStage,HashMap<Integer,Platos> numPlt,Integer opcion,Restaurante restaurante,String id){
        ...
        RetornarButton.setOnAction(new EventHandler<ActionEvent>() {
            public void handle(ActionEvent event) {
                ...
                root.pantallaCliente(primaryStage,id);
            }
        });
    ...
    public static void pantallaModificarPlatos(Stage primaryStage,HashMap<Integer,Platos> numPlt,Integer opcion, Restaurante restaurante,String id){
        PaneModificarPlatos root4=new PaneModificarPlatos(primaryStage);        
        Scene scene=new Scene(root4.getRoot(),500,600);
        primaryStage.setScene(scene);
        root4.DiseñoVentanaPlatos(primaryStage,numPlt,opcion,restaurante,id);
        primaryStage.show();
    }
